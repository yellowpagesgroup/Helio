...
class HelpersTests(unittest.TestCase):
    ...
    @patch('helio.controller.helpers.COMPONENT_BASE_DIRECTORIES', ('mock-cbd',))
    def test_single_controller_import(self):
        ...
        with patch('helio.controller.helpers.load_source', return_value=component_module) as mock_import:
            imported_controller = import_controllers(component_name)
            mock_import.assert_called_with('component', 'mock-cbd/test/component/component.py')
